...
- **Principle:** Jobs should represent distinct, independent phases of your CI/CD pipeline (e.g.,
...
- **Rolling Update (Default for Deployments):** Gradually replaces instances of the old version with
